...
<script type="text/javascript">
	...
	<div class="job-head-box mb20">
		<div class="banner">
			<h1 title="上海客户经理就业形势分析" class="headtitle ml30" style="padding-top: 10px;">${city}${jobName} &bull; 工资分析</h1>
			<p class="fs16 gray9 mb20 ml30" style="padding-bottom: 20px;"> ${city}${jobName}： 岗位分析如下</p>
	...
	<div class="row" style="margin-bottom: 10px;">
		...
		<div class="col-md-5">
			<div style="background-color: #fff;height: 300px;">
				<div class="demo">您选择的职业：${jobName}</div>

				<div class="demo1">您选择的城市：${city}</div>
				<div class="demo2">您选择的经验：${exp}</div>
				<div class="predict">预测最低工资：￥${(salaryPredictInfoMap.预测最低工资) ! "暂无数据"}</div>
				<div class="predict">预测最高工资：￥${(salaryPredictInfoMap.预测最高工资) ! "暂无数据"}</div>
			</div>
		</div>
		<div class="col-md-5" style="background-color: white;height: 300px;margin-left: 10px">

            <div  style="">
                    <h2 class="fs16" style="padding-left: 20px;padding-top: 5px;font-family: bold">${city}${jobName}-${exp}的工资情况</h2>
                <#list salaryPercentInfos as salaryPercentInfo>
                    <div >
                        <div class="col-md-4">
                            <span style="padding-left: 10px;text-align: center;">${(salaryPercentInfo.工资情况)!"暂无数据"}</span>
                        </div>
                        <div class="col-md-8">
                            <div class="progress">
                                <div class="progress-bar success" role="progressbar"
                                     style="width: ${(salaryPercentInfo.比例) ! '0'}%" aria-valuenow="${(salaryPercentInfo.比例) ! '0'}" aria-valuemin="0"
                                     aria-valuemax="100">${(salaryPercentInfo.比例) ! '0'}%
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<div class="row" style="margin-bottom: 10px;">
		...
		<div class="col-md-4">
			<div style="background-color: #fff;height: 300px;">
				<div class="money">平均工资￥${aveSalary!"暂无数据"}</div>
				<div class="spans">分析近${(recordCount.记录总数)!"0"}条数据 | ${(recordCount.城市数量)!"0"}个不同城市</div>
...
<script src="${rc.contextPath}/static/js/analizePage2.js"></script>
